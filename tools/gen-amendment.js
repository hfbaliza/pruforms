...
sections.push({
  ...
  questions: [
    ...
    { id: 'kyc_civil', q: 'What is your civil status?', type: 'radio',
      options: [
...
sections.push({
  ...
  questions: [
    ...
    { id: 'li_gender', q: "Life Insured's gender?", type: 'radio',
      ...
      options: [{ value: '1', label: 'Male' }, { value: '2', label: 'Female' }],
      map: [{ radio: 'change-G1' }] },
    { id: 'li_civil', q: "Life Insured's civil status?", type: 'radio',
      showIf: { q: 'sec2_gate', eq: 'yes' },
      options: [
        { value: '1', label: 'Single' },
        { value: '2', label: 'Married' },
  ...
  questions: [
    ...
    { id: 'po_signature', q: 'Policyowner — please sign.', type: 'signature', required: true,
      map: [
        ...
        { image: { page: 5, rect: [47, 502, 275, 517], grow: 3.0 } },
      ] },
    { id: 'witness_name', q: 'Full name of your witness? (Skip if none.)', type: 'text',
      map: [{ text: 'SIGNATURE-1.0.0.0.1', size: 8 }] },
    { id: 'witness_signature', q: 'Witness — please sign.', type: 'signature',
      showIf: { q: 'witness_name', truthy: true },
      map: [{ image: { page: 5, rect: [317, 502, 545, 517], grow: 3.0 } }] },
    ...
    { id: 'li_signature', q: 'Life Insured — please sign.', type: 'signature',
      ...
      map: [{ image: { page: 5, rect: [47, 469, 275, 485], grow: 3.0 } }] },
    { id: 'po_customary', q: 'Policyowner — draw your customary signature.',
      help: 'This certifies that the signature appearing on all your forms and valid IDs is your customary signature. It is placed in the three specimen boxes.',
      type: 'signature', required: true,
      map: [
        { image: { page: 5, rect: [237, 355, 332, 400] } },
        { image: { page: 5, rect: [346, 355, 442, 400] } },
        { image: { page: 5, rect: [456, 355, 551, 400] } },
      ] },
    ...
    { id: 'irrev1_signature', q: 'Irrevocable Beneficiary 1 — please sign.',
      help: 'The signature is also placed in their customary-signature specimen boxes.',
      type: 'signature', required: true,
      showIf: { q: 'irrev_applies', eq: 'yes' },
      map: [
        { image: { page: 5, rect: [317, 469, 545, 486], grow: 3.0 } },
        { image: { page: 5, rect: [239, 275, 334, 320] } },
        { image: { page: 5, rect: [348, 275, 444, 320] } },
        { image: { page: 5, rect: [455, 275, 550, 320] } },
      ] },
    ...
    { id: 'irrev2_signature', q: 'Irrevocable Beneficiary 2 — please sign.', type: 'signature',
      showIf: { q: 'irrev2_name', truthy: true },
      map: [
        { image: { page: 5, rect: [47, 435, 275, 452], grow: 3.0 } },
        { image: { page: 5, rect: [239, 216, 334, 260] } },
        { image: { page: 5, rect: [348, 216, 444, 260] } },
        { image: { page: 5, rect: [455, 216, 550, 260] } },
      ] },
    ...
    { id: 'irrev3_signature', q: 'Irrevocable Beneficiary 3 — please sign.', type: 'signature',
      showIf: { q: 'irrev3_name', truthy: true },
      map: [
        { image: { page: 5, rect: [317, 435, 545, 451], grow: 3.0 } },
        { image: { page: 5, rect: [239, 159, 334, 204] } },
        { image: { page: 5, rect: [348, 159, 444, 204] } },
        { image: { page: 5, rect: [455, 159, 550, 204] } },
      ] },
  ],
});
